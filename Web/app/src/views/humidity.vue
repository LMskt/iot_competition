    ...
    <div style="text-align: center">
      ...
      <div>
        ...
        <div style="float: left;margin-left: 100px">
          <div id="tu" ><img src="../../public/sa.png" style="width: 100px;height: 100px" alt="" ></div>
          <div id="tu2" style="display: none"><img src="../../public/sa2.png" style="width: 100px;height: 100px" alt="" ></div>
        </div>
      </div>
    </div>
  </div>
  ...
  watch:{
    isFollow(newVal,oldVal){
      this.dom.setOption({
        ...
        series: [{
          data:store.getters.get_shi_x
        }]
      })
      this.big=store.getters.get_shi_m[1]
      this.small=store.getters.get_shi_m[0]
      if(store.getters.get_bool[1]==false){
        // console.log("超过了！")
    ...
    yuzhi(newVal,oldVal){
      store.commit('set_shi_zhi',newVal)
